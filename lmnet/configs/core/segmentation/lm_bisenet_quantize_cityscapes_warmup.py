...
def warmup_scheduler(learning_rate, global_step, warmup_learning_rate, warmup_step):
    import tensorflow as tf
    ...
    def lr_scheduler(global_step):
        ...
        return tf.where(global_step < warm_stp, warmup_rate, base_lr)
...
NETWORK.LEARNING_RATE_FUNC = warmup_scheduler
